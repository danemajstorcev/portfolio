...
const projects: Project[] = [
  ...
  },
  {
    ...
    desc: "A modern e-commerce frontend for browsing and showcasing smartphones with a clean, product-focused UI. It includes user authentication with sign-in and sign-up functionality, a secure checkout and payment option, and an integrated AI chatbot that helps users choose the right phone based on their needs, preferences, and budget.",
