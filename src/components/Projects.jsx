  ...
  return (
    <section className="section projects-section" id="projects">
      ...
      <p className="projects-note">
        ...
        <a href="https://github.com/danemajstorcev" target="_blank" rel="noreferrer">
          @danemajstorcev
        </a>
      </p>
      ...
      <div className="projects-grid">
        {projects.map(p => (
          <article className={`project-card ${p.featured ? 'project-card--featured' : ''}`} key={p.num}>
            <div className="project-top">
              <span className="project-num">{p.num}</span>
              <div className="project-icons">
                <a href={p.github} target="_blank" rel="noreferrer" title="GitHub" className="project-icon-link">
                ...
                {p.live !== '#' && (
                  <a href={p.live} target="_blank" rel="noreferrer" title="Live Demo" className="project-icon-link">
